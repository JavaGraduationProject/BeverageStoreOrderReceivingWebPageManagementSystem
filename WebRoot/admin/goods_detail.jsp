                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kcnum" name="kcnum" value="${goods.kcnum}" placeholder="请输入库存：" >
                                        </div>
                                        <div class="form-group">
                                            <label for="fid">分类：</label>
                                            <select class="form-control" id="exampleFormControlSelect1" name="fid" id="fid">
                                                <c:forEach items="${flist }" var="t">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="etime" placeholder="请输入有效期："  value="${goods.etime}" onclick="WdatePicker();" >
                                        </div>
                                        <div class="form-group">
                                            <label for="price">位置：</label>
                                            <input type="text" class="form-control"  name="guige" value="${goods.guige}" placeholder="请输入位置："  >
                                        </div>
                                        <div class="form-group">
