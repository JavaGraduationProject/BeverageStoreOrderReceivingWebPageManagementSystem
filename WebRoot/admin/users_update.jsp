    ...
    <div class="main-panel">
        <div class="content">
            <div class="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="updateUsers.do" method="post" enctype="multipart/form-data" ><!-- enctype="multipart/form-data" -->
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-4">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="password" name="pwd" value="${users.pwd}">
                                            <small id="checkPwdc" class="form-text text-muted"></small>
                                        </div>
                                        <div class="form-group">
                                            <label for="tname">姓名：</label>
                                            <input type="text" class="form-control" id="tname" name="tname" value="${users.tname}">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <select class="form-control" id="exampleFormControlSelect1" name="utype">
                                                <option value="${users.utype}">${users.utype}</option>
