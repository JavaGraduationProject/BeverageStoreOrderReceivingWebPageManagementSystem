...
<!-- Chart JS -->
<script src="<%=path%>/admin/assets/js/plugin/chart.js/chart.min.js"></script>

<!-- jQuery Sparkline -->
<script src="<%=path%>/admin/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

<!-- Chart Circle -->
<script src="<%=path%>/admin/assets/js/plugin/chart-circle/circles.min.js"></script>

<!-- Datatables -->
<script src="<%=path%>/admin/assets/js/plugin/datatables/datatables.min.js"></script>

<!-- Bootstrap Notify -->
<script src="<%=path%>/admin/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

<!-- jQuery Vector Maps -->
<script src="<%=path%>/admin/assets/js/plugin/jqvmap/jquery.vmap.min.js"></script>
<script src="<%=path%>/admin/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

<!-- Sweet Alert -->
<script src="<%=path%>/admin/assets/js/plugin/sweetalert/sweetalert.min.js"></script>

<!-- Atlantis JS -->
<script src="<%=path%>/admin/assets/js/atlantis.min.js"></script>

<!-- Atlantis DEMO methods, don't include it in your project! -->
<script src="<%=path%>/admin/assets/js/setting-demo.js"></script>
<script src="<%=path%>/admin/assets/js/demo.js"></script>
