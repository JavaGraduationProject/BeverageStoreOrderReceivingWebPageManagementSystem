                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="${news.name}" placeholder="请输入新闻名"  >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="note" rows="5" name="note">${news.note}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
