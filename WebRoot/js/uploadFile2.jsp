...
if(filename!=null)
{
 ...
 var txt = parentcument.getElementById("txt3");
 var filename = parentcument.getElementById("filename3");
 filename.value="<%=filename%>";
 txt.value="/xiaoyuandingcan/upload/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="../admin/SubjectServlet?method=uploadFile2" enctype="multipart/form-data" name="f1" method="post">
