...
if(filename!=null)
{
 ...
 var txt = parentcument.getElementById("txt5");
 var filename = parentcument.getElementById("filename5");
 filename.value="<%=filename%>";
 txt.value="/xiaoyuandingcan/upload/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="../admin/SubjectServlet?method=uploadFile4" enctype="multipart/form-data" name="f1" method="post">
