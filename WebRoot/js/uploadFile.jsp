...
if(filename!=null)
{
 ...
 var txt = parentcument.getElementById("txt2");
 var filename = parentcument.getElementById("filename2");
 filename.value="<%=filename%>";
 txt.value="/xiaoyuandingcan/upload/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="../admin/SubjectServlet?method=uploadFile" enctype="multipart/form-data" name="f1" method="post">
