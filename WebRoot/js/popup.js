var tcolor={
   ...
   function uploadimg()
	{
	pop('/xiaoyuandingcan/js/uploadimg.jsp',"上传图片",300,200)
	}

    /*function uploadFile()
    {
        pop("/xiaoyuandingcan/js/uploadFile.jsp","上传文件",300,200)
    }
    function uploadFile2()
    {
        pop("/xiaoyuandingcan/js/uploadFile2.jsp","上传文件",300,200)
    }*/
...
build:function(){
   ...
   //var close='<input type="image" id="dialogBoxClose" src="'+path+'/js/dialogclose.gif" border="0" width="16" height="16" align="absmiddle" title="关闭"/>';
   var close='<img id="dialogBoxClose" title="关闭" src=/xiaoyuandingcan/js/dialogclose.gif  />';
